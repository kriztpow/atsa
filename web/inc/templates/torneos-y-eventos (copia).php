	    ...
	    <div id="accordion-deportes">
	   	...
	   	<!-- item tab -->
		  	...
		  	<div class="contenido-accordion-deportes">
		  		<ul>
		  			<li>
		  				<a href="uploads/pdfs/resultados-voley femenino-2da-categoria.pdf" target="_blank">
		  					Resultados Voley 2da categoria
		  				</a>
		  			</li>
		  			<li>
		  				<a href="uploads/pdfs/resultados-voley femenino-1ra-categoria.pdf" target="_blank">
		  					Resultados Voley 1era categoria
		  				</a>
		  			</li>
		  			<li>
		  				<a href="uploads/pdfs/5tay6ta-fecha-voley.pdf" target="_blank">
		  					5ta y 6ta fecha voley
		  				</a>
		  			</li>
		  			<li>
		  				<a href="uploads/pdfs/futbol-11-a-cuartos.pdf" target="_blank">
		  					Fútbol 11 (A) Cuartos de final
		  				</a>
		  			</li>
		  			<li>
		  			...
		  			<li>
		  				<a href="uploads/pdfs/5ta-fecha-futbol-11-b.pdf" target="_blank">
		  					5º Fecha Fútbol 11 (B)
		  				</a>
		  			</li>
		  			<li>
