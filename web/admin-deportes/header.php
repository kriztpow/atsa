  ...
  <!--MENU EDITOR: administrar pagina-->
          <?php if ( $userStatus == '0' || $userStatus == '1' ) : ?>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a href="index.php?admin=partidos" role="button">
                    Partidos
                  </a>
                </li>
                
                <li>
                  <a href="index.php?admin=posts" role="button">
                    Contenidos
                  </a>
                </li>

                <li>
                  <a href="index.php?admin=liga" role="button">
                    Liga
                  </a>
                </li>

                <li>
                  <a href="index.php?admin=equipos" role="button">
                    Equipos
                  </a>
                </li>
                <li>
          ...
          <li><a href="../torneos-y-eventos" target="_blank">Ver página</a></li>
          </ul>
  <!--RIGHT MENU: usuario-->
