      ...
      <div class="tab-content">
        ...
        <div id="sectionB" class="tab-pane fade">
          <ul class="about_columns">
            ...
            <p>
              Contamos con una gran variedad de oferta de cursos y talleres para los niños y niñas de 3 a 12 años. Además, llevamos adelante obras de teatro, ciclos de cine y eventos exclusivos para nuestro público infantil.
            </p>
            </li>
            <li class="list">
            <div class="fa fa-star fa-1x">
            ...
            Jóvenes</h4>
            <p>
              Abrimos las puertas de nuestro Complejo para todos aquellos que quieran compartir su arte con sus compañeros. Pueden utilizar el escenario para tocar con su banda, las salas para exponer cuadros o el teatro para realizar una obra de teatro.
            </p>
            </li>
            <li class="list right">
            <h4>
            ...
            <p>
              Además de la amplia variedad de cursos y talleres para adultos, proponemos a los adultos que participen del Primer Elenco Estable del Complejo Cultural Sanidad, en donde se realizan obras propias, con ideas de compañeros y compañeras.
            </p>
            </li>
            <li class="list">
            <div class="fa fa-star fa-1x">
            ...
            Vitalicios</h4>
            <p>
              Nuestros compañeros vitalicios pueden disfrutar de los talleres específicos para ellos, como Teatro, Cerámica, Escritura, Tango, entre otros. Además, llevamos adelante una agenda especial para que nuestros vitalicios puedan disfrutar del espacio con sus nietos o realizar actividades organizadas por nuestra Casa Celeste y Blanca.
             </p>
            </li>
            <li class="list right">
            <h4>
            ...
            <p>
              Todos los meses realizamos la Peña de la Sanidad, donde compartimos noches de música en vivo, comidas regionales y mucha buena onda. Durante el año vamos recorriendo distintos géneros musicales como folklore y rock, entre otros.
            </p>
            </li>
            <li class="list ">
            <div class="fa fa-star fa-1x">
            ...
            Establecimientos</h4>
            <p>
              Nuestro Complejo es un espacio exclusivo para trabajadores de la Sanidad. Invitamos a todos nuestros compañeros a organizarse junto con los delegados de cada establecimiento para poder asistir a las peñas o eventos multitudinarios que realizamos en este espacio.
        	 </p>
            </li>
          </ul>
        </div>
