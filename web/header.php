...
<header class="main-header">
    ...
    <?php 
        if ($pageActual != 'home' && $pageActual != 'acceso-delegados' && $pageActual != 'delegados-videos' && $pageActual != 'torneos-y-eventos' && $pageActual != 'OFFLINE-torneos-y-eventos' && $pageActual != 'deportes' ) {
