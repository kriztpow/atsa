...
<header class="main-header">
    ...
    <?php 
        if ($pageActual != 'home' ) {
            ...
            if ($pageActual == 'hoteles-y-espacios-recreativos' || $pageActual == 'programas-prevencion' || $pageActual == 'trabajadores' || $pageActual == 'celeste-y-blanca' || $pageActual == 'torneos-y-eventos' || $pageActual == 'viajes' ) {
            ?>
