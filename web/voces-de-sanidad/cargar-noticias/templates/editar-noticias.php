...
$resumen2     = isset($dataPost['resumen2']) ? $dataPost['resumen2']:'';
...
$destacado    = isset($dataPost['destacado']) ? $dataPost['destacado'] : '0';
...
<div class="contenido-modulo">
	...
	<!------ RESUMEN DE LA NOTICIA ---------->
					...
					<div class="form-group">
						<label for="post_resumen" class="larger-label">Resumen de la noticia 2</label>
						<textarea id="post_resumen_2" name="post_resumen_2"><?php echo $resumen2; ?></textarea>
					</div>			
				</div><!-- // col -->
	...
	<!------ POST DESTACADO ---------->
					<div class="form-group checkbox-destacado">
						<label for="post_destacado">Post Destacado
						<input name="post_destacado" type="checkbox" value="true" <?php 
											if ( $destacado == 1 ) {
												echo 'checked';
											}
											?>></label>
